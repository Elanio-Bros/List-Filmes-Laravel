...
//     Route::post('/filme/{code_url}/voto/', [App\Http\Controllers\Filme::class, 'avaliacao_filme']);
//     Route::post('/filme/{code_url}/grupo/', [App\Http\Controllers\Filme::class, 'criar_grupo_comentario']);
//     Route::post('/filme/{code_url}/grupo/comentario', [App\Http\Controllers\Filme::class, 'comentario_grupo_filme']);
